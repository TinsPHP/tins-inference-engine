...
public class OperatorFromGreaterThanTest extends AInferenceNamespaceTypeTest
{
    ...
    public static Collection<Object[]> testStrings() {
        ...
        return asList(new Object[][]{
                ...
                //uMinus
                {"-null;", testStructs("(uMinus null)", "\\.\\.", asList("nullType"), 1, 0, 0)},
                {"-false;", testStructs("(uMinus false)", "\\.\\.", asList("falseType"), 1, 0, 0)},
                {"-true;", testStructs("(uMinus true)", "\\.\\.", asList("trueType"), 1, 0, 0)},
                {"-1;", testStructs("(uMinus 1)", "\\.\\.", asList("int"), 1, 0, 0)},
                {"-1.5;", testStructs("(uMinus 1.5)", "\\.\\.", asList("float"), 1, 0, 0)},
                {"-'hello';", testStructs("(uMinus 'hello')", "\\.\\.", asList("string"), 1, 0, 0)},
                //uPlus
                {"+null;", testStructs("(uPlus null)", "\\.\\.", asList("nullType"), 1, 0, 0)},
                {"+false;", testStructs("(uPlus false)", "\\.\\.", asList("falseType"), 1, 0, 0)},
                {"+true;", testStructs("(uPlus true)", "\\.\\.", asList("trueType"), 1, 0, 0)},
                {"+1;", testStructs("(uPlus 1)", "\\.\\.", asList("int"), 1, 0, 0)},
                {"+1.5;", testStructs("(uPlus 1.5)", "\\.\\.", asList("float"), 1, 0, 0)},
                {"+'a';", testStructs("(uPlus 'a')", "\\.\\.", asList("string"), 1, 0, 0)},
                //if
