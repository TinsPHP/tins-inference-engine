        ...
        return asList(new Object[][]{
                ...
                },
                {
                        ...
                        testStructs("foo()", "\\.\\.", matcherDtos(
                                matcherDto(
                                        varBinding("foo().@4|0", "V1", asList("string"), asList("string"), true),
                                        ...
                                        varBinding("foo()$name", "V3", asList("string"), asList("string"), true),
                                        varBinding(RETURN_VARIABLE_NAME, "V4",
                                                asList("string"), asList("string"), true),
                                        varBinding("return@2|0", "V5", asList("string"), asList("string"), true)
                                ),
                                matcherDto(
                                        varBinding("foo().@4|0", "V1", asList("string"), asList("string"), true),
                                        //is constant as well since there is no parametric overload of . operator
                                        varBinding("'hello '@3|0", "V2", asList("string"), asList("{as string}"), true),
                                        varBinding("foo()$name", "V3",
                ...
                },
                {
                        ...
                        testStructs("foo()", "\\.\\.", matcherDtos(matcherDto(
                                ...
                                varBinding(RETURN_VARIABLE_NAME, "V12", asList("int"), asList("int"), true),
                                varBinding("return@2|0", "V13", asList("int"), asList("int"), true)
                        )), 1, 0, 2)
                },
                {
                        "function foo(){ $a \n= \n1; $b \n= \n2; \nreturn \n3;}",
                        testStructs("foo()", "\\.\\.", matcherDtos(matcherDto(
                                ...
                                varBinding("return@6|0", "V9", asList("int"), asList("int"), true)
                        )), 1, 0, 2)
                },
                //see TINS-405 multiple return cause NullPointerException
                {
                        "function foo(){\nreturn \n1; \nreturn \n1.2;}",
                        testStructs("foo()", "\\.\\.", matcherDtos(matcherDto(
                                varBinding(RETURN_VARIABLE_NAME, "V1", asList("int", "float"), numUpper, true),
                                varBinding("1@3|0", "V2", asList("int"), null, true),
                                varBinding("return@2|0", "V3", asList("int"), asList("int"), true),
                                varBinding("1.2@5|0", "V4", asList("float"), null, true),
                                varBinding("return@4|0", "V5", asList("float"), asList("float"), true)
                        )), 1, 0, 2)
                },
                {
                        "function foo($x){ \nif($x){ \nreturn \n1;} \nreturn \n1.2;}",
                        testStructs("foo()", "\\.\\.", matcherDtos(
                                matcherDto(
                                        ...
                                        varBinding("return@3|0", "V3", asList("int"), asList("int"), true),
                                        varBinding("if@2|0", "V4", asList("mixed"), asList("mixed"), true),
                                        varBinding("foo()$x", "V5", boolLower, boolUpper, true),
                                        varBinding("1.2@6|0", "V6", asList("float"), null, true),
                                        varBinding("return@5|0", "V7", asList("float"), asList("float"), true)
                                ),
                                matcherDto(
                                        varBinding(RETURN_VARIABLE_NAME, "V1", asList("int", "float"), numUpper, true),
                                        varBinding("1@4|0", "V2", asList("int"), null, true),
                ...
                //see TINS-449 unused ad-hoc polymorphic parameters
                {
                        ...
                        testStructs("foo()", "\\.\\.", matcherDtos(
                                //int x int -> int
                                matcherDto(
                                        varBinding("foo()+@3|0", "V1", asList("int"), asList("int"), true),
                                        varBinding("foo()$x", "V2", asList("int"), asList("int"), true),
                                        varBinding("foo()$y", "V3", asList("int"), asList("int"), true),
                                        varBinding("foo()=@2|0", "V4", asList("int"), asList("int"), true),
                                        varBinding("foo()$a", "V4", asList("int"), asList("int"), true),
                                        varBinding(RETURN_VARIABLE_NAME, "V6", asList("int"), asList("int"), true),
                                        varBinding("1@5|0", "V7", asList("int"), null, true),
                                        varBinding("return@4|0", "V8", asList("int"), asList("int"), true)
                                ),
                                //float x float -> int
                                matcherDto(
                                        varBinding("foo()+@3|0", "V1", asList("float"), asList("float"), true),
                                        varBinding("foo()$x", "V2", asList("float"), asList("float"), true),
                                        varBinding("foo()$y", "V3", asList("float"), asList("float"), true),
                                        varBinding("foo()=@2|0", "V4", asList("float"), asList("float"), true),
                                        varBinding("foo()$a", "V4", asList("float"), asList("float"), true),
                                        varBinding(RETURN_VARIABLE_NAME, "V6", asList("int"), asList("int"), true),
                                        varBinding("1@5|0", "V7", asList("int"), null, true),
                                        varBinding("return@4|0", "V8", asList("int"), asList("int"), true)
                                ),
                                ...
                                matcherDto(
                                        varBinding("foo()+@3|0", "V1", asList("float"), asList("float"), true),
                                        varBinding("foo()$x", "V2", asList("float"), asList("float"), true),
                                        varBinding("foo()$y", "V3", asNum, asNum, true),
                                        varBinding("foo()=@2|0", "V4", asList("float"), asList("float"), true),
                                        varBinding("foo()$a", "V4", asList("float"), asList("float"), true),
                                        varBinding(RETURN_VARIABLE_NAME, "V6", asList("int"), asList("int"), true),
                                        varBinding("1@5|0", "V7", asList("int"), null, true),
                                ...
                                //{as num} x {as num} -> int
                                matcherDto(
                                        varBinding("foo()+@3|0", "V1", numLower, numUpper, true),
                                        varBinding("foo()$x", "V2", asNum, asNum, true),
                                        varBinding("foo()$y", "V3", asNum, asNum, true),
                                        varBinding("foo()=@2|0", "V4", numLower, numUpper, true),
                                        varBinding("foo()$a", "V4", numLower, numUpper, true),
                                        varBinding(RETURN_VARIABLE_NAME, "V6", asList("int"), asList("int"), true),
                                        varBinding("1@5|0", "V7", asList("int"), null, true),
                                        varBinding("return@4|0", "V8", asList("int"), asList("int"), true)
                                ),
                                //array x array -> int
                                matcherDto(
                                        varBinding("foo()+@3|0", "V1", asList("array"), asList("array"), true),
                                        varBinding("foo()$x", "V2", asList("array"), asList("array"), true),
                                        varBinding("foo()$y", "V3", asList("array"), asList("array"), true),
                                        varBinding("foo()=@2|0", "V4", asList("array"), asList("array"), true),
                                        varBinding("foo()$a", "V4", asList("array"), asList("array"), true),
                                        varBinding(RETURN_VARIABLE_NAME, "V6", asList("int"), asList("int"), true),
                                        varBinding("1@5|0", "V7", asList("int"), null, true),
                                        varBinding("return@4|0", "V8", asList("int"), asList("int"), true)
                                )
