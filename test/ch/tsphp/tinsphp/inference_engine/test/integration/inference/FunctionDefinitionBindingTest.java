                        ...
                        testStructs("force_balance_tags()", "\\.\\.", matcherDtos(
                                matcherDto(
                                        varBinding("force_balance_tags()myPregReplace()@2|21",
                                                "V1", asList("string", "array"), null, true),
                                        varBinding("'#<([0-9]{1})#'@2|35", "V2", asList("string"), null, true),
                                        varBinding("'&lt;$1'@2|52", "V3", asList("string"), null, true),
                                        varBinding("force_balance_tags()casting@2|12",
                                                "V5", asList("string"), null, true),
                                        varBinding("string@2|13", "V6", asList("string"), null, true),
                                        varBinding("force_balance_tags()$text", "V7",
                                                null, asList("(array | string)"), true),
                                        varBinding("force_balance_tags()=@2|10", "V7",
                                                null, asList("(array | string)"), true),
                                        varBinding("force_balance_tags()$regex", "V8", asList("array"), null, true),
                                        varBinding("force_balance_tags()=@3|10", "V8", asList("array"), null, true),
                                        varBinding("array@3|11", "V10", asList("array"), null, true),
                                        varBinding("force_balance_tags()myPregMatch()@4|12",
                                                "V11", asList("falseType", "int"), null, true),
                                        varBinding("\"/<(\\/?[\\w:]*)\\s*([^>]*)>/\"@4|24",
                                                "V12", asList("string"), null, true),
                                        varBinding("while@4|4", "V13", asList("mixed"), null, true),
                                        varBinding("return@6|4", "V14", asList("nullType"), null, true),
                                        varBinding("null@6|11", "V15", asList("nullType"), null, true),
                                        varBinding(RETURN_VARIABLE_NAME, "V16", asList("nullType"), null, true)
                                ),
                                matcherDto(
                                        varBinding("force_balance_tags()myPregReplace()@2|21",
                                                "V1", asList("string", "array"), null, true),
                                        ...
                                        varBinding("force_balance_tags()casting@2|12",
                                                "V5", asList("string"), null, true),
                                        varBinding("string@2|13", "V6", asList("string"), null, true),
                                        varBinding("force_balance_tags()$text", "V7", null, asList("string"), true),
                                        varBinding("force_balance_tags()=@2|10", "V7", null, asList("string"), true),
                                        varBinding("force_balance_tags()$regex", "V8", asList("array"), null, true),
                                        varBinding("force_balance_tags()=@3|10", "V8", asList("array"), null, true),
                                        varBinding("array@3|11", "V10", asList("array"), null, true),
                                        varBinding("force_balance_tags()myPregMatch()@4|12",
