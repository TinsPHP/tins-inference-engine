...
//                // and
//                {"$x = (bool) true; false and $x;", testStructs("(and false $x)", "", asList("false"), null, 1, 2,
// 0)},
//                {"$x = (bool) true; $x and false;", testStructs("(and $x false)", "", asList("false"), null, 1, 2,
// 0)},
...
//                {"$x = (bool) 1 ? 1 : 1.5; $x += $x;", testStructs("(+= $x $x)", "", asList("num"), null, 1, 2, 0)},
...
//                {"$x = (bool) 1 ? 1 : 1.5; $x *= $x;", testStructs("(*= $x $x)", "", asList("num"), null, 1, 2, 0)},
//                // /=
//                {"$x = true; $x /= false;", testStructs("(/= $x false)", "", asList("{int V false}"), null, 1, 2, 0)},
//                {"$x = 1.3; $x /= 1.3;", testStructs("(/= $x 1.3)", "", asList("{false V float}"), null, 1, 2, 0)},
//                {
//                        "$x = (bool) 1 ? 1 : 1.5; $x /= $x;",
//                        testStructs("(/= $x $x)", "", asList("{num V false}"), null, 1, 2, 0)
//                },
//                // %=
//                {"$x = 1; $x %= 1;", testStructs("(%= $x 1)", "", asList("{int V false}"), null, 1, 2, 0)},
//                // |=
//                {"$x = 1; $x |= 1;", testStructs("(|= $x 1)", "", asList("int"), null, 1, 2, 0)},
...
//                {
//                        "$x = (bool) 1; $x ? 1 : 1.3;",
//                        testStructs("(? $x 1 1.3)", "", asList("{int V float}"), null, 1, 2, 0)
//                },
//                {
//                        "$x = (bool) 1; $x ? [1] : 1.3;",
//                        testStructs("(? $x (array 1) 1.3)", "", asList("{float V array}"), null, 1, 2, 0)
//                },
//                // ||
...
//                // &&
//                {"$x = (bool) true; false && $x;", testStructs("(&& false $x)", "", asList("false"), null, 1, 2, 0)},
//                {"$x = (bool) true; $x && false;", testStructs("(&& $x false)", "", asList("false"), null, 1, 2, 0)},
...
//                {"$x = (bool) 1 ? 1 : 1.5; $x * $x;", testStructs("(* $x $x)", "", asList("num"), null, 1, 2, 0)},
//                // /
//                {"true / false;", testStructs("(/ true false)", "", asList("{int V false}"), null, 1, 0, 0)},
//                {"2.1 / 1.5;", testStructs("(/ 2.1 1.5)", "", asList("{false V float}"), null, 1, 0, 0)},
//                {
//                        "$x = (bool) 1 ? 1 : 1.5; $x / $x;",
//                        testStructs("(/ $x $x)", "", asList("{num V false}"), null, 1, 2, 0)
//                },
//                // %
//                {"2 % 1;", testStructs("(% 2 1)", "", asList("{int V false}"), null, 1, 0, 0)},
//                //instanceof
//                {"$x = 1; 1 instanceof $x;", testStructs("(instanceof 1 $x)", "", asList("bool"), null, 1, 2, 0)},
//                // casting
...
//                {"(string) 1;", testStructs("(casting (type tMod string) 1)", "", asList("string"), null, 1, 0, 0)},
//                {"(array) 1;", testStructs("(casting (type tMod array) 1)", "", asList("array"), null, 1, 0, 0)},
//                // preIncr
//                {"$x = false; ++$x;", testStructs("(preIncr $x)", "", asList("bool"), null, 1, 2, 0)},
//                {"$x = true; ++$x;", testStructs("(preIncr $x)", "", asList("bool"), null, 1, 2, 0)},
//                {"$x = 1; ++$x;", testStructs("(preIncr $x)", "", asList("int"), null, 1, 2, 0)},
//                {"$x = 1.5; ++$x;", testStructs("(preIncr $x)", "", asList("float"), null, 1, 2, 0)},
//                {"$x = (bool) 1 ? 1 : 1.5; ++$x;", testStructs("(preIncr $x)", "", asList("num"), null, 1, 2, 0)},
//                //preDecr
//                {"$x = false; --$x;", testStructs("(preDecr $x)", "", asList("bool"), null, 1, 2, 0)},
//                {"$x = true; --$x;", testStructs("(preDecr $x)", "", asList("bool"), null, 1, 2, 0)},
//                {"$x = 1; --$x;", testStructs("(preDecr $x)", "", asList("int"), null, 1, 2, 0)},
//                {"$x = 1.5; --$x;", testStructs("(preDecr $x)", "", asList("float"), null, 1, 2, 0)},
//                {"$x = (bool) 1 ? 1 : 1.5; --$x;", testStructs("(preDecr $x)", "", asList("num"), null, 1, 2, 0)},
//                // postIncr
//                {"$x = false; $x++;", testStructs("(postIncr $x)", "", asList("bool"), null, 1, 2, 0)},
//                {"$x = true; $x++;", testStructs("(postIncr $x)", "", asList("bool"), null, 1, 2, 0)},
//                {"$x = 1; $x++;", testStructs("(postIncr $x)", "", asList("int"), null, 1, 2, 0)},
//                {"$x = 1.5; $x++;", testStructs("(postIncr $x)", "", asList("float"), null, 1, 2, 0)},
//                {"$x = (bool) 1 ? 1 : 1.5; $x++;", testStructs("(postIncr $x)", "", asList("num"), null, 1, 2, 0)},
//                //postDecr
//                {"$x = false; $x--;", testStructs("(postDecr $x)", "", asList("bool"), null, 1, 2, 0)},
//                {"$x = true; $x--;", testStructs("(postDecr $x)", "", asList("bool"), null, 1, 2, 0)},
//                {"$x = 1; $x--;", testStructs("(postDecr $x)", "", asList("int"), null, 1, 2, 0)},
//                {"$x = 1.5; $x--;", testStructs("(postDecr $x)", "", asList("float"), null, 1, 2, 0)},
//                {"$x = (bool) 1 ? 1 : 1.5; $x--;", testStructs("(postDecr $x)", "", asList("num"), null, 1, 2, 0)},
//                //@
