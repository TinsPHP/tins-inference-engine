...
public class ResolveScalarTypeTest extends ATypeSystemTest
{

    private String type;

    public ResolveScalarTypeTest(String theType) {
        type = theType;
    }
    ...
    public void testResolveExistingType_ReturnExisting() {
        ...
        ITypeSymbol result = referencePhaseController.resolveScalarType(ast, null);
