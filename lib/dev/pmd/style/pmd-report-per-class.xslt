                ...
                <xsl:for-each select="file">
                    ...
                    <h3>
                        <xsl:value-of disable-output-escaping="yes"
                                      select="translate(substring-before(@name,'.java'),'/','.')"/>
                    </h3>
                    <table border="0" width="100%" class="sortable">
                        <xsl:attribute name="id">sortable_id_<xsl:value-of select="position()"/>
                        </xsl:attribute>
                        <tr>
                            <th>Prio</th>
                            <th>Begin Line</th>
                        ...
                        <xsl:for-each select="violation">
                            <tr>
                                ...
                                <td style="padding: 3px" align="left">
                                    <xsl:value-of disable-output-escaping="yes" select="@method"/>
                                </td>
                    ...
                    <table border="0" width="100%" class="classcount">
                        <tr>
                            <th>Total number of violations for this class:
                                <xsl:value-of select="count(violation)"/>
                            </th>
                        </tr>
                    </table>
