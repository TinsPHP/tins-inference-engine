...
public class OverloadRankingDto
{
    ...
    public IUnionTypeSymbol lowerBound;
    public IIntersectionTypeSymbol upperBound;

    public OverloadRankingDto(IFunctionType theOverload, IOverloadBindings theBindings) {
